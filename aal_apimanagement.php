...
?>    
	...
	<br /><br />
	After you activate the modules, you need to set them up by clicking "Configure" link in the table or going to each module menu in wordpress administration sidebar. ( Amazon Links, Clickbank Links, Shareasale Links ).
<br /><br />
	...
	<tr class="alternate">
		...
		<td><?php if(get_option('aal_amazonactive')=='1') { ?><a href="<?php echo admin_url('admin.php?page=aal_module_amazon'); ?>">Configure Amazon Module</a><?php } ?></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td><?php if(get_option('aal_clickbankactive')=='1') { ?><a href="<?php echo admin_url('admin.php?page=aal_module_clickbank'); ?>">Configure Clickbank Module</a><?php } ?></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr class="alternate">
		...
		<td><?php if(get_option('aal_shareasaleactive')=='1') { ?><a href="<?php echo admin_url('admin.php?page=aal_module_shareasale'); ?>">Configure Shareasale Module</a><?php } ?></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>	
	<tr>
		...
		<td><?php if(get_option('aal_cjactive')=='1') { ?><a href="<?php echo admin_url('admin.php?page=aal_module_cj'); ?>">Configure Commission Junction Module</a><?php } ?></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>	
	<tr class="alternate">
		...
		<td><?php if(get_option('aal_bestbuyactive')=='1') { ?><a href="<?php echo admin_url('admin.php?page=aal_module_bestbuy'); ?>">Configure Best Buy Module</a><?php } ?></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>	
	<tr>
		...
		<td><?php if(get_option('aal_ebayactive')=='1') { ?><a href="<?php echo admin_url('admin.php?page=aal_module_ebay'); ?>">Configure Ebay Module</a><?php } ?></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>	
	<tr>
		...
		<td><?php if(get_option('aal_walmartactive')=='1') { ?><a href="<?php echo admin_url('admin.php?page=aal_module_walmart'); ?>">Configure Walmart Module</a><?php } ?></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>	
	<tr>
		...
		<td><?php if(get_option('aal_envatoactive')=='1') { ?><a href="<?php echo admin_url('admin.php?page=aal_module_envato'); ?>">Configure Envato Module</a><?php } ?></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
