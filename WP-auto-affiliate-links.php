...
function wpaal_create_menu() {
	...
	if(get_option('aal_apikey')) $proname = 'API Management';
	...
	<div class="wrap">  
        ...
        <div id="aal_panel3">
            ...
            <form name="add-link" method="post" action="<?php echo admin_url( "admin-ajax.php");?>" id="aal_add_new_link_form">
                ...
                <a href="javascript:;" class="aal_form_toggle_advanced" onclick="" >Show advanced options</a>
                <span class="aal_form_advanced_options">	
                	Title: <input class="aal_biginput_title" type="text" name="aal_title" id="aal_formtitle" placeholder="optional" />
					 </span>
