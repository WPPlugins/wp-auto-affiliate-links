...
class Aal_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		?>
			This widget works only with <a href="http://autoaffiliatelinks.com">Auto Affiliate Links PRO</a>. To activate it you need to get <a href="http://autoaffiliatelinks.com/wp-login.php?action=register">your API key</a>.
